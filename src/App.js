  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route exact path="quinn" element={<Home locationID="38" location="quinn" locationName="Quinn House" taxonid={taxonid} setTaxonID={setTaxonID} />} />
        <Route path="quinn/:id" element={<Home locationID="38" location="quinn" locationName="Quinn House" taxonid={taxonid} setTaxonID={setTaxonID} />} />
        <Route path="quinn/species/:id" element={<Home locationID="38" location="quinn" locationName="Quinn House" taxonid={taxonid} setTaxonID={setTaxonID} species="true" />} />
        <Route path="quinn/obs/:id" element={<Home locationID="38" location="quinn" locationName="Quinn House" taxonid={taxonid} setTaxonID={setTaxonID} obs="true" />} />

        <Route exact path="spectacle" element={<Home locationID="100" location="spectacle" locationName="Spectacle Island" taxonid={taxonid} setTaxonID={setTaxonID} />} />
        <Route path="spectacle/:id" element={<Home locationID="100" location="spectacle" locationName="Spectacle Island" taxonid={taxonid} setTaxonID={setTaxonID} />} />
        <Route path="spectacle/species/:id" element={<Home locationID="100" location="spectacle" locationName="Spectacle Island" taxonid={taxonid} setTaxonID={setTaxonID} species="true" />} />
        <Route path="spectacle/obs/:id" element={<Home locationID="100" location="spectacle" locationName="Spectacle Island" taxonid={taxonid} setTaxonID={setTaxonID} obs="true" />} />
